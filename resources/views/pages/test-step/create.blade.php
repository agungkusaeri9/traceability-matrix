                        ...
                        <div class='form-group mb-3'>
                            ...
                            <div class='form-group'>
                                ...
                                <select name='status' id='status'
                                    ...
                                    <option @selected(old('status') == 0) value='0' selected>Pilih Status</option>
                                    <option @selected(old('status') == 1) value="1">Success</option>
                                    <option @selected(old('status') == 2) value="2">Failed</option>
                                </select>
                                @error('status')
                                    <div class='invalid-feedback'>
                                        {{ $message }}
